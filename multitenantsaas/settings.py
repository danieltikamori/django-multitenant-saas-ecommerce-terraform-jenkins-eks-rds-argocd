...
# Docker host : host.docker.internal  or database service name: amlume-django-postgresdb
# docker inspect amlume-django-postgresdb | grep "IPAddress"
# DATABASES = {
#     'default': {
...
#         'HOST': os.environ.get("POSTGRES_HOST", "amlume-django-postgresdb"),
